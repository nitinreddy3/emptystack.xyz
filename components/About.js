    ...
    <div className="container px-4 mx-auto">
      <div className="lg:space-x-5 lg:flex lg:flex-row item-center lg:-mx-4 flex flex-col-reverse text-center lg:text-left">
        ...
        <div className="flex-shrink-0 lg:mt-12 lg:px-4 mb-10">
          <a href="https://app.daily.dev/nitinreddy3" rel="noreferrer"><Image src="https://api.daily.dev/devcards/e80b5cd7453c4402aa5c5320adaf04c4.png?r=93f" alt="Nitin Reddy's Dev Card" width="400" height="550" /></a>
        ...
        <div className="lg:px-4 lg:mt-12 ">
          ...
          <div className="mt-6 text-emerald-800 dark:text-white">
            ...
            <p className="mb-6">
              {`I love exploring new technologies like Flutter and python. I'm a self-taught developer with a passion for learning and building things. Currently working as a Senior Software Engineer at `}<a className={"transition-colors hover:text-blue-500"} href="https://www.iglooinsure.com" target="_blank" rel="noreferrer"><b>Igloo</b></a>.
            </p>
            <p>
