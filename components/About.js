      ...
      <div className="lg:space-x-5 lg:flex lg:flex-row item-center lg:-mx-4 flex flex-col-reverse text-center lg:text-left">
        ...
        <div className="lg:px-4 lg:mt-12 ">
          ...
          <div className="mt-6 text-emerald-800 dark:text-white">
            ...
            <p className="mb-6">
              I love exploring new technologies like Flutter and python. I'm a self-taught developer with a passion for learning and building things. Currently working as a Senior Software Engineer at <a className={"transition-colors hover:text-blue-500"} href="https://www.iglooinsure.com" target="_blank"><b>Igloo</b></a>.
            </p>
            <p>
